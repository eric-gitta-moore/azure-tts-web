  ...
  const locate = {
    ...
    "contents": {
      ...
      "vs/editor/contrib/codeAction/browser/codeActionMenu": {
        "codeAction.widget.id.convert": "转换...",
        ...
        "customCodeActionWidget": "代码操作小组件",
        "customCodeActionWidget.labels": "{0}，禁用原因: {1}",
        "hideMoreCodeActions": "隐藏已禁用项",
        "label": "按 {0} 以应用，按 {1} 以预览",
        "showMoreCodeActions": "显示已禁用项"
      },
      "vs/editor/contrib/codeAction/browser/codeActionWidgetContribution": {
        "codeActionWidget": "启用此选项可调整代码操作菜单的呈现方式。",
        "showCodeActionHeaders": "如果启用了自定义代码操作菜单，则启用此项将显示包含组标头的代码操作菜单。"
      },
      ...
      "vs/platform/environment/node/argv": {
        ...
        "settingsProfileName": "Opens the provided folder or workspace with the given profile and associates the profile with the workspace. If the profile does not exist, a new empty one is created. A folder or workspace must be provided for the profile to take effect.",
      ...
      "vs/platform/terminal/common/terminalPlatformConfiguration": {
        "terminal.integrated.automationProfile.linux": "要在 Linux 上用于自动化相关终端使用(如任务和调试)的终端配置文件。如果设置了 {0} (现已弃用)，则当前将忽略此设置。",
        "terminal.integrated.automationProfile.osx": "要在 macOS 上用于自动化相关终端使用(如任务和调试)的终端配置文件。如果设置了 {0} (现已弃用)，则当前将忽略此设置。",
        "terminal.integrated.automationProfile.windows": "要用于自动化相关终端使用(如任务和调试)的终端配置文件。如果设置了 {0} (现已弃用)，则当前将忽略此设置。",
        ...
        "terminalProfile.windowsSource": "将自动检测 shell 路径的配置文件源。请注意，非标准可执行文件位置不受支持，必须在新的配置文件中手动创建。"
      },
      ...
      "vs/server/node/serverEnvironmentService": {
        "acceptLicenseTerms": "如果已设置，则用户接受服务器许可条款，并将在没有用户提示的情况下启用服务器。",
        "connection-token": "必须包含在所有请求中的机密。",
        "connection-token-file": "包含连接令牌的文件的路径。",
        "default-folder": "未在浏览器 URL 中指定输入时要打开的工作区文件夹。已针对当前工作目录解析相对或绝对路径。",
        "default-workspace": "未在浏览器 URL 中指定输入时要打开的工作区。已针对当前工作目录解析相对或绝对路径。",
        ...
        "start-server": "安装或卸载扩展时启动服务器。将与 “install-extension”、“install-builtin-extension” 和 “uninstall-extension” 结合使用。",
        "telemetry-level": "设置初始遥测级别。有效级别为: “off”、 crash”、“error” 和 “all”。如果未指定，服务器将在客户端连接之前发送遥测数据，然后将使用客户端遥测设置。将此项设置为 “off” 等效于 --disable-telemetry",
        "without-connection-token": "在没有连接令牌的情况下运行。仅当通过其他方式保护连接时才使用此项。"
      },
      "win32/i18n/messages": {
      ...
      "vs/code/electron-sandbox/issue/issueReporterPage": {
        ...
        "issueTypeLabel": "这是一个",
        "reviewGuidanceLabel": "在此处报告问题之前，请<a href=\"https://github.com/microsoft/vscode/wiki/Submitting-Bugs-and-Suggestions\" target=\"_blank\">查看我们提供的指南</a>。",
      ...
      "vs/workbench/api/common/configurationExtensionPoint": {
        ...
        "scope.enumItemLabels": "要在“设置”编辑器中显示的枚举值的标签。指定后，{0}值仍显示在标签之后，但突出显示较少。",
      ...
      "vs/workbench/browser/window": {
        ...
        "learnMore": "了解详细信息",
        "open": "打开",
        "openExternalDialogButtonContinue": "单击此处",
        "openExternalDialogButtonInstall": "安装 {0}",
        "openExternalDialogButtonRetry": "重试",
        "openExternalDialogDetail": "我们已尝试在计算机上打开 {0}。",
      ...
      "vs/workbench/common/theme": {
        ...
        "windowActiveBorder": "窗口处于活动状态时用于窗口边框的颜色。当使用自定义标题栏时，仅在 macOS 和 Linux 桌面客户端中受支持。",
        "windowInactiveBorder": "窗口处于非活动状态时用于窗口边框的颜色。当使用自定义标题栏时，仅在 macOS 和 Linux 桌面客户端中受支持。"
      },
      ...
      "vs/workbench/contrib/debug/browser/debugAdapterManager": {
        ...
        "suppressMultipleSessionWarning": "在尝试多次启动同一调试配置时禁用该警告。"
      },
      ...
      "vs/workbench/contrib/editSessions/browser/editSessions.contribution": {
        "autoResume": "控制是否自动继续当前工作区的可用编辑会话。",
        "autoResume.off": "切勿尝试恢复编辑会话。",
        "autoResume.onReload": "在窗口重新加载时自动恢复可用的编辑会话。",
        "autoStore": "控制是否自动存储当前工作区的可用编辑会话。",
        "autoStore.off": "从不尝试自动存储编辑会话。",
        "autoStore.onShutdown": "在窗口关闭时自动存储当前编辑会话。",
        "autoStoreEditSession": "正在存储当前编辑会话...",
        ...
        "continueEditSessionPick.title": "继续 {0}",
        ...
        "resuming edit session window": "正在恢复编辑会话...",
        "show edit session": "显示编辑会话",
        "show log": "显示日志",
        "store current.v2": "存储当前编辑会话",
        "store edit session": "正在存储编辑会话...",
      ...
      "vs/workbench/contrib/editSessions/browser/editSessionsViews": {
        ...
        "confirm delete all": "是否确实要永久性删除所有编辑会话? 无法撤消此操作。",
        "noEditSessions": "没有要显示的已存储编辑会话。\r\n{0}",
        "open file": "打开文件",
        "storeEditSessionCommand": "[{0}](command:workbench.editSessions.actions.store)",
        "storeEditSessionTitle": "存储编辑会话",
        "workbench.editSessions.actions.delete": "删除编辑会话",
        "workbench.editSessions.actions.deleteAll": "删除所有编辑会话",
        "workbench.editSessions.actions.resume": "继续编辑会话",
        "workbench.editSessions.actions.store": "存储编辑会话"
      },
      ...
      "vs/workbench/contrib/mergeEditor/browser/commands/commands": {
        ...
        "merge.goToPreviousUnhandledConflict": "Go to Previous Unhandled Conflict",
      ...
      "vs/workbench/contrib/mergeEditor/browser/mergeEditorInput": {
        "cancel": "取消",
        "closeWithConflicts": "关闭(存在冲突)",
        "conflict1": "是否要在 {0} 中存在冲突的情况下关闭?",
        "conflictN": "是否要在 {0} 文件中存在冲突的情况下关闭?",
        "detail1": "文件包含未处理的冲突。如果不保存更改，则更改将丢失。",
        "detailN": "文件包含未经处理的冲突。如果不保存更改，则更改将丢失。",
        "detailNotDirty1": "文件包含未经处理的冲突。",
        "detailNotDirtyN": "文件包含未经处理的冲突。",
        "discard": "Don't Save",
        "message1": "是否要保存对 {0} 的更改?",
        "messageN": "是否要保存对 {0} 文件所做的更改?",
        "name": "正在合并: {0}",
        "saveWithConflict": "保存(存在冲突)"
      },
      "vs/workbench/contrib/mergeEditor/browser/mergeMarkers/mergeMarkersController": {
        "conflictingLine": "1 Conflicting Line",
        "conflictingLines": "{0} Conflicting Lines"
      },
      ...
      "vs/workbench/contrib/offline/browser/offline.contribution": {
        ...
        "statusBarOfflineBackground": "工作台脱机时的状态栏背景色。状态栏显示在窗口底部",
        "statusBarOfflineBorder": "工作台脱机时用来与侧边栏和编辑器区分的状态栏边框颜色。状态栏显示在窗口底部。",
        "statusBarOfflineForeground": "工作台脱机时的状态栏前景色。状态栏显示在窗口底部"
      },
      ...
      "vs/workbench/contrib/tasks/browser/task.contribution": {
        ...
        "task.showDecorations": "显示终端缓冲区中兴趣点的修饰，例如通过监视任务发现的第一个问题。请注意，这只会对将来的任务生效。{0} 将优先于此设置",
      ...
      "vs/workbench/contrib/userDataProfile/browser/userDataProfileActions": {
        ...
        "create temporary profile": "Create a Temporary Settings Profile",
        "current": "当前",
        "delete profile": "删除...",
        ...
        "profileExists": "名为 {0} 的设置配置文件已存在。",
        "rename profile": "重命名...",
        "reset workspaces": "重置工作区设置配置文件关联",
      ...
      "vs/workbench/services/clipboard/browser/clipboardService": {
        "clipboardError": "无法从浏览器的剪贴板中读取。请确保你已授予此网站从剪贴板中读取的访问权限。",
        "learnMore": "了解详细信息",
        "retry": "重试"
      },
      ...
      "vs/workbench/services/dialogs/browser/simpleFileDialog": {
        ...
        "remoteFileDialog.validateCreateDirectory": "文件夹 {0} 不存在。是否要创建它?",
      ...
      "vs/workbench/services/extensions/common/extensionsRegistry": {
        ...
        "vscode.extension.activationEvents.onEditSession": "在使用给定方案访问编辑会话时发出的激活事件。",
...
// ------------------------invoke----------------------------------------
        export function localize(path, data, defaultMessage, ...args) {
            ...
            var data = ${JSON.stringify(locate.contents)} || {};
